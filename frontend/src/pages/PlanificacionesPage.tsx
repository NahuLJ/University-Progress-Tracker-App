            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-text-muted mt-1">
                        ...
                        <button type="button" onClick={() => navigate('/trayectorias')} className="text-accent-primary hover:underline">
                            Trayectorias
                        </button>.
                    </p>
                </div>
                <Button variant="primary" onClick={() => setMostrarNuevoPeriodo(true)}>
                    + Nueva planificación
                </Button>
            </div>
